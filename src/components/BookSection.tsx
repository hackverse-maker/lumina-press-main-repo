...
export const BookSection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#2B4A4A] py-16 lg:py-24" id="books">
      ...
      <div className="container-tight relative z-10 px-6 sm:px-10 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] gap-12 lg:gap-x-24 lg:gap-y-8 items-center lg:items-start">
          ...
          <motion.div
            ...
            className="relative flex justify-center perspective-[1000px] order-2 lg:order-1 lg:row-span-2"
          >
          ...
          <motion.div 
            ...
            className="flex flex-col sm:flex-row items-center gap-4 order-3 lg:order-3 lg:col-start-2 lg:mt-2"
          >
            <Link 
            ...
            <Link 
              href={`/books/${mainBook.id}`}
              className="w-full sm:w-auto border-2 border-white/80 hover:border-white text-white px-8 py-4 lg:px-10 lg:py-5 text-lg font-black uppercase tracking-wider rounded-md transition-all hover:bg-white/10 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3 whitespace-nowrap"
            >
              The Book Archive
            </Link>
          </motion.div>
