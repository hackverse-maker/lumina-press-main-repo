  ...
  return (
    ...
    >
      <Link 
        ...
        className="w-full sm:w-[40%] aspect-[16/10] overflow-hidden rounded-2xl bg-secondary shrink-0"
      >
        <img
          src={article.thumb}
          alt={article.title}
      ...
      <div className="flex flex-col justify-center flex-1">
        ...
        <div className="mt-8">
          <Link 
            href={`/articles/${article.slug}`}
            className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-wide group/btn"
          >
            Read Article 
